...
type Student struct {
	...
	IsOsArch bool   `protobuf:"varint,4,opt,name=isOsArch,proto3" json:"isOsArch,omitempty"`
}
...
func (x *Student) GetStream() string {
	if x != nil {
		return x.Stream
	}
	return ""
...
func (x *Student) GetLanguage() string {
	if x != nil {
		return x.Language
	}
	return ""
...
func (x *Student) GetIsOsArch() bool {
	if x != nil {
		return x.IsOsArch
	}
	return false
...
var file_main_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x6d, 0x0a, 0x07,
	...
	0x65, 0x61, 0x6d, 0x12, 0x1a, 0x0a, 0x08, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x12,
	0x1a, 0x0a, 0x08, 0x69, 0x73, 0x4f, 0x73, 0x41, 0x72, 0x63, 0x68, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x08, 0x69, 0x73, 0x4f, 0x73, 0x41, 0x72, 0x63, 0x68, 0x22, 0x33, 0x0a, 0x0b, 0x53,
	0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x24, 0x0a, 0x08, 0x73, 0x74,
...
var file_main_proto_goTypes = []interface{}{
	...
	(*StudentList)(nil), // 1: StudentList
}
var file_main_proto_depIdxs = []int32{
	0, // 0: StudentList.students:type_name -> Student
